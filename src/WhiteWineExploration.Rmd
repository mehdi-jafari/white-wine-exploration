...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height=15, fig.width=9} 

ggpairs(white_wine[, 2:13], 
...
As it is shown in the above mentioned result, the follwoing pairs have the most 
